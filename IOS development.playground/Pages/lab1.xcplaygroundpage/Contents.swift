...
let myLiveStory = """
    My name is \(myName) \(mySurname). I'm \(myAge), born in \(myBirthYear). I live in \(myCity). I'm \(myHeight) meters tall and weigh \(myWeight) kilograms. I like \(myFavHobby). My favorite number is \(myFavNumber). I have \(numberOfHobbies) hobbies. My favorite number is \(myFavNumber). I'm a student at KBTU.
    """
